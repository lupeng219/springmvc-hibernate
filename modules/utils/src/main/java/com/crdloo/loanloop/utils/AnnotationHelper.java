...
public class AnnotationHelper
{
    ...
    public static <T> T get(AnnotatedElement element, Class<T> annotationClazz) {
    ...
    public static <T> Argument<T> get(Method method, Object[] args, Class<T> annotationClazz) {
    ...
    public static Argument[] gets(Method method, Object[] args) {
    ...
    public static <T> Argument<T>[] gets(Method method, Object[] args, Class<T> annotationClazz) {
    ...
    public static Argument[] getsWithRetval(Method method, Object[] args, Object retval) {
        ArrayList<Argument> results = new ArrayList<Argument>();
        ...
        if (retval instanceof Response) {
            ...
            if (response.getData() != null) {
                argument.type = response.getData().getClass();
                argument.value = response.getData();
            }
