...
public class NamedMap {
    protected HashMap<String, HashMap<String, String>> namedMap = new HashMap<String, HashMap<String, String>>();
    ...
    public NamedMap(String defaultName) {
        ...
        currentName = new NamedInheritableThreadLocal<String>(
    ...
    public Boolean getBooleanValue(String key) {
        ...
        if (strValue != null) {
            try {
                if ("true".equalsIgnoreCase(strValue) || "on".equalsIgnoreCase(strValue)
                        || "yes".equalsIgnoreCase(strValue))
                    return true;

                if ("false".equalsIgnoreCase(strValue) || "off".equalsIgnoreCase(strValue)
