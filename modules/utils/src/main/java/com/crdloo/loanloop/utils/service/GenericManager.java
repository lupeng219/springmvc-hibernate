...
public interface GenericManager<T, PK> {
    ...
    @WebMethod(operationName = "findByExample1")
    public List<T> findByExample(T entity);

    @WebMethod(operationName = "findByExample2")
    public Page<T> findByExample(T entity, Pageable page);

    @WebMethod(operationName = "findByExample3")
    public List<T> findByExample(T entity, T orEntity);

    @WebMethod(operationName = "findByExample4")
