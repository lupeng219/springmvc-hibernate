 ...
 */
    ...
    */
     ...
     * @return
     */
    public static  Integer todayLeftSeconds(){
     ...
     * @return
     */
    public static Date addDayToDate(Date date, int x) {
    ...
    public static String getLast1Day(int day){
